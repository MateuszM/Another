        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DiaryTitle = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Diary_AspNetUsers_AplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentPage = table.Column<string>(nullable: true),
                    Registration = table.Column<DateTime>(nullable: false),
                    IsChanged = table.Column<bool>(nullable: false),
                    DiaryModelId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pages_Diary_DiaryModelId",
                        column: x => x.DiaryModelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Diary_AplicationUserId",
                table: "Diary",
                column: "AplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Pages_DiaryModelId",
                table: "Pages",
                column: "DiaryModelId");
        }
